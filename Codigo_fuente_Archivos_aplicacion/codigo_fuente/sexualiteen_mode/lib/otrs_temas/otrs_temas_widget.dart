...
import 'otrs_temas_model.dart';
export 'otrs_temas_model.dart';

class OtrsTemasWidget extends StatefulWidget {
  const OtrsTemasWidget({
    super.key,
  ...
  @override
  State<OtrsTemasWidget> createState() => _OtrsTemasWidgetState();
}

class _OtrsTemasWidgetState extends State<OtrsTemasWidget> {
  late OtrsTemasModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OtrsTemasModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'otrsTemas'});
              ...
              child: Row(
                ...
                children: [
                  FlutterFlowIconButton(
                    ...
                    onPressed: () async {
                      logFirebaseEvent(
                          'OTRS_TEMAS_arrow_back_rounded_ICN_ON_TAP');
                                    ...
                                    child: Align(
                                      ...
                                      child: Padding(
                                        ...
                                        child: InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'OTRS_TEMAS_PAGE_ListTile_pbmcgdux_ON_TAP');
                                            logFirebaseEvent(
