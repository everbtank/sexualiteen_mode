...
import 'dsr_page_model.dart';
export 'dsr_page_model.dart';

class DsrPageWidget extends StatefulWidget {
  const DsrPageWidget({
    super.key,
  ...
  @override
  State<DsrPageWidget> createState() => _DsrPageWidgetState();
}

class _DsrPageWidgetState extends State<DsrPageWidget> {
  late DsrPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DsrPageModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'DsrPage'});
              ...
              child: Row(
                ...
                children: [
                  FlutterFlowIconButton(
                    ...
                    onPressed: () async {
                      logFirebaseEvent('DSR_arrow_back_rounded_ICN_ON_TAP');
                              ...
                              itemBuilder: (context, listViewIndex) {
                                ...
                                return Padding(
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'DSR_PAGE_PAGE_Container_rszoezn1_ON_TAP');
